...
function extend() {
  for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ["__proto__", "constructor", "prototype"], a = 1; a < arguments.length; a += 1) {
    ...
    if (null != i) for (var s = Object.keys(Object(i)).filter(function (e) {
      ...
      void 0 !== l && l.enumerable && (isObject(e[o]) && isObject(i[o]) ? i[o].__swiper__ ? e[o] = i[o] : extend(e[o], i[o]) : !isObject(e[o]) && isObject(i[o]) ? (e[o] = {}, i[o].__swiper__ ? e[o] = i[o] : extend(e[o], i[o])) : e[o] = i[o]);
    }
  }
...
function slideTo(e, t, a, i, s) {
  ...
  if (n.updateProgress(w), l.normalizeSlideIndex) for (var y = 0; y < p.length; y += 1) {
    ...
    void 0 !== p[y + 1] ? x >= E && x < T - (T - E) / 2 ? o = y : x >= E && x < T && (o = y + 1) : x >= E && (o = y);
  }
...
var checkOverflow$1 = {
  ...
  return t.enable = function () {
    ...
    if (0 === i.length && t.params.createElements) {
      ...
      i = $(s), s.className = t.params.wrapperClass, a.append(s), a.children("." + t.params.slideClass).each(function (e) {
        i.append(e);
      });
    }
    ...
    if (t.enabled) {
      ...
      if (!(r.shiftKey || r.altKey || r.ctrlKey || r.metaKey || i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase()))) {
        if (t.params.keyboard.onlyInViewport && (l || d || p || u || c || h)) {
          ...
          for (var x = [[y.left, y.top], [y.left + m, y.top], [y.left, y.top + g], [y.left + m, y.top + g]], E = 0; E < x.length; E += 1) {
            var T = x[E];
  ...
  handle: function (e) {
    ...
    if (a.enabled) {
      ...
      if (l >= a.minTranslate() && (l = a.minTranslate()), l <= a.maxTranslate() && (l = a.maxTranslate()), (!!a.params.loop || !(l === a.minTranslate() || l === a.maxTranslate())) && a.params.nested && t.stopPropagation(), a.params.freeMode) {
        ...
        if (y.push(w), x ? (w.direction !== x.direction || w.delta > x.delta || w.time > x.time + 150) && a.mousewheel.animateSlider(w) : a.mousewheel.animateSlider(w), a.mousewheel.releaseScroll(w)) return !0;
      }
    ...
    if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
      ...
      if ("fraction" === a.type && (r.find(classesToSelector(a.currentClass)).text(a.formatFractionCurrent(i + 1)), r.find(classesToSelector(a.totalClass)).text(a.formatFractionTotal(n))), "progressbar" === a.type) {
        ...
        var x = (i + 1) / n,
            E = 1,
            T = 1;
        "horizontal" === y ? E = x : T = x, r.find(classesToSelector(a.progressbarFillClass)).transform("translate3d(0,0,0) scaleX(" + E + ") scaleY(" + T + ")").transition(e.params.speed);
      }
  ...
  setTranslate: function () {
    ...
    for (var v = 0; v < s.length; v += 1) {
      ...
      var w = Math.max(Math.min(f[0].progress, 1), -1),
          ...
          x = 0,
          E = 0;
      m % 4 == 0 ? (y = 4 * -b * l, E = 0) : (m - 1) % 4 == 0 ? (y = 0, E = 4 * -b * l) : (m - 2) % 4 == 0 ? (y = l + 4 * b * l, E = l) : (m - 3) % 4 == 0 && (y = -l, E = 3 * l + 4 * l * b), o && (y = -y), u || (x = y, y = 0);
